...
With those similarities in mind, let's make a real example using the `penguins` dataset (which can be found in the R [`palmerpenguins`](https://allisonhorst.github.io/palmerpenguins/) package).
...
Plot.barY(species_ct_js,
          {x: "species", y: "n", fill: "yellow", stroke: "blue"}).plot()
```
